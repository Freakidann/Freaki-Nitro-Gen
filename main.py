...
# Github: https://github.com/Freakidann
...
class Console():        
    def ui(self):
        os.system(f'cls && title [FNG] Freakidann Nitro Generator  ^|  For Help Mp moi Freakidann#5818' if os.name == "nt" else "clear")
        print(center(f"""\n\n
██████╗███╗   ██╗ ██████╗ 
██════╝████╗  ██║██╔════╝            ~ Freakidann Nitro Generator ~
██║██╗ ██╔██╗ ██║██║  ███╗     
██╔══╝ ██║╚██╗██║██║   ██║     github.com/Freakidann ~
██║    ██║ ╚████║╚██████╔╝ 
╚═╝    ╚═╝  ╚═══╝ ╚═════╝ \n\n
